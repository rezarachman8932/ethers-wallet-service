...
contract EnterpriseDocumentNFT is ERC721URIStorage, AccessControl {
    ...
    event DocumentIssued(uint256 indexed tokenId, address indexed owner, address indexed issuer);
    ...
    function issueDocument(
        ...
        emit DocumentIssued(tokenId, to, msg.sender);
        return tokenId;
    }
    ...
    function revokeDocument(uint256 tokenId) external onlyRole(ISSUER_ROLE) {
        ...
        require(
            _documentMeta[tokenId].issuer == msg.sender ||
